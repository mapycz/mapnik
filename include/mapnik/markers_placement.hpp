...
public:
    ...
    bool get_point(double &x, double &y, double &angle, box2d<double> &box, bool ignore_placement)
    {
        ...
        default:
        case MARKER_POINT_PLACEMENT:
            return point_.get_point(x, y, angle, box, ignore_placement);
        case MARKER_INTERIOR_PLACEMENT:
            return interior_.get_point(x, y, angle, box, ignore_placement);
        case MARKER_LINE_PLACEMENT:
            return line_.get_point(x, y, angle, box, ignore_placement);
        case MARKER_VERTEX_FIRST_PLACEMENT:
            return vertex_first_.get_point(x, y, angle, box, ignore_placement);
        case MARKER_VERTEX_LAST_PLACEMENT:
            return vertex_last_.get_point(x, y, angle, box, ignore_placement);
        }
    }
