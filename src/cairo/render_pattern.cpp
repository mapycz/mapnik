...
cairo_common_pattern_process_visitor::cairo_common_pattern_process_visitor(
...
cairo_surface_ptr cairo_common_pattern_process_visitor::operator() (marker_null const &) const
{
    throw std::runtime_error("This should not have been reached.");
}

template <typename Marker>
cairo_surface_ptr cairo_common_pattern_process_visitor::operator() (Marker const & marker) const
{
...
template
cairo_surface_ptr cairo_common_pattern_process_visitor::operator() (
...
agg::trans_affine cairo_common_pattern_process_visitor::transform(box2d<double> & bbox) const
{
...
cairo_surface_ptr cairo_common_pattern_process_visitor::render_pattern(
...
cairo_surface_ptr cairo_common_pattern_process_visitor::render_pattern_alternating(
    marker_svg const & marker,
    box2d<double> const & bbox,
    agg::trans_affine tr) const
{
